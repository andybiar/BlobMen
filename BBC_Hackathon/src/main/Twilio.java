...
//our phone number 19162627089
public class Twilio {
	/** The Constant ACCOUNT_SID. */
	public static final String ACCOUNT_SID = "AC8388cbffa4174ee19d422e503fa22300";

	/** The Constant AUTH_TOKEN. */
	public static final String AUTH_TOKEN = "18dc8b59ca44e6e45b623e2b89a3d4a1";
	...
	public static void main(String[] args) throws TwilioRestException {
		...
		callParams.put("To", "9167088467"); // Replace with a valid phone number
		callParams.put("From", "9162627089"); // Replace with a valid phone
		...
		smsParams.put("To", "9167088467"); // Replace with a valid phone number
		smsParams.put("From", "9162627089"); // Replace with a valid phone
													// number in your account
